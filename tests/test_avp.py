...
class AVPTest(unittest.TestCase):
    ...
    def test_integer_avp(self):
        ...
        self.assertEquals(1, len(avp.children))
        self.assertEquals(26, avp.avp_code.value)       # vendor-specific
        self.assertEquals(10415, avp.avp_value.value)   # 3gpp value 10415
        self.assertEquals(23, avp.children[0].avp_code.value) # 3gpp-ms-time-zone
        self.assertEquals(100, avp.children[0].avp_value.value) # 100
    ...
    def test_string_avp(self):
        ...
        self.assertEquals(67, avp.children[0].avp_code.value)
        self.assertEquals("hello_world", avp.children[0].avp_value.value)


    def test_string_no_vendor_avp(self):
        avp = radius.RadiusAvp("Called-Station-Id", "1234567890")
        self.assertIsNotNone(avp)
        self.assertEquals(0, len(avp.children))
    ...
    def test_integer_value_avp(self):
        ...
        self.assertEquals(4, avp.children[0].avp_code.value)
        self.assertEquals(1, avp.children[0].avp_value.value)
