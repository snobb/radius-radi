...
class AVPTest(unittest.TestCase):
    ...
    def test_integer_avp(self):
        ...
        self.assertEqual(26, avp.avp_code.value)  # vendor-specific
        self.assertEqual(10415, avp.avp_value.value)  # 3gpp value 10415
        # 3gpp-ms-time-zone
        self.assertEqual(23, avp.avp_subavp[0].avp_code.value)
        self.assertEqual(100, avp.avp_subavp[0].avp_value.value)  # 100
    ...
    def test_string_avp(self):
        ...
        self.assertTrue(avp.has_sub_avps())
        self.assertEqual(26, avp.avp_code.value)  # vendor-specific
        self.assertEqual(54, avp.avp_value.value)  # dhcp value 54
        self.assertEqual(67, avp.avp_subavp[0].avp_code.value)
        self.assertEqual("hello_world", avp.avp_subavp[0].avp_value.value)

    def test_string_no_vendor_avp(self):
        avp = libradi.RadiusAvp("Called-Station-Id", "1234567890")
        self.assertIsNotNone(avp)
        self.assertFalse(avp.has_sub_avps())
        self.assertEqual(30, avp.avp_code.value)
        self.assertEqual("1234567890", avp.avp_value.value)
    ...
    def test_integer_value_avp(self):
        ...
        self.assertTrue(avp.has_sub_avps())
        self.assertEqual(26, avp.avp_code.value)  # vendor-specific
        self.assertEqual(3375, avp.avp_value.value)  # F5 networks 3375
        self.assertEqual(4, avp.avp_subavp[0].avp_code.value)
        self.assertEqual(1, avp.avp_subavp[0].avp_value.value)
    ...
    def test_avp_dump(self):
        ...
        self.assertEqual(31, avp.avp_code.value)
        binary = avp.dump()
        ...
        self.assertEqual(exp_bin.dump(), binary)
        ...
        exp_bin = libradi.radtypes.get_type_instance("byte",
                                                     ...
                                                     len(avp))
        self.assertEqual(exp_bin.dump(), avp.dump())
    ...
    def test_avp_dump_vendor(self):
        ...
        self.assertTrue(avp.has_sub_avps())
        self.assertEqual(26, avp.avp_code.value)  # vendor-specific
        self.assertEqual(10415, avp.avp_value.value)  # 3GPP 10415
        # exported from a tcpdump with a libradi packet
        exp_bin = libradi.radtypes.get_type_instance(
    ...
    def test_avp_str(self):
        ...
        exp_str = ("AVP: Type:Framed-IP-Address(ipaddr) Length:6 "
                   "Value:10.0.0.1")
        self.assertEqual(exp_str, str(avp))
