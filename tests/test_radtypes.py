...
class RadTypesTest(unittest.TestCase):
    ...
    def test_byte_type(self):
        byte = radtypes.get_type_instance("byte", 125)
    ...
    def test_byte_type_multi(self):
        byte = radtypes.get_type_instance("byte", 0x11aa22bb, length=4)
        self.assertIsNotNone(byte)
        ...
        self.assertEquals((0x11, 0xaa, 0x22, 0xbb),
            tuple(radtypes.get_numeric_array(0x11aa22bb, 4, 1)))
        self.assertEquals("\x11\xaa\x22\xbb", byte.dump())


    def test_integer_type(self):
        integer = radtypes.get_type_instance("integer", 0x11f)
    ...
    def test_integer_type_many(self):
        integer = radtypes.get_type_instance("integer", 0x11aa22bb, length=2)
        self.assertIsNotNone(integer)
    ...
    def test_short_type(self):
        short = radtypes.get_type_instance("short", 0x11f)
    ...
    def test_short_type_many(self):
        short = radtypes.get_type_instance("short", 0x11aa22bb, length=2)
        self.assertIsNotNone(short)
    ...
    def test_bits_to_ip4mask(self):
        addr = radtypes.get_type_instance("ipaddr", "10.0.0.1")
    ...
    def test_address_type_ipv4(self):
        ...
        exp_bin = radtypes.get_type_instance("byte", 0x0a000001, 4)
        self.assertEquals(exp_bin.dump(), addr.dump())


    def test_address_type_ipv6(self):
        addr = radtypes.get_type_instance("ipaddr", "2001:abcd::1")
        self.assertIsNotNone(addr)
    ...
    def test_text_type(self):
        addr = radtypes.get_type_instance("string", "helloworld")
        self.assertIsNotNone(addr)
